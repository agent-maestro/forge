...
pull requests, discussions, the EML language Slack/Discord if
established, conferences, etc.), and also applies when an individual
is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior
may be reported to the project maintainers at contact@monogate.dev.
