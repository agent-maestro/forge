...
def test_rescue_obligation_registry_marks_complete_concrete_witness_coverage():
    packet = run_suite()
    ...
    assert by_operator["precision_escape"]["status"]["proven"] is True
    assert by_operator["precision_escape"]["machlib_witness"]["theorem"] == (
        "precision_escape_witness_discharges_concrete_obligation"
    )
