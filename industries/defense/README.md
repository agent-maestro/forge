...
**Certification target:** MIL-STD-882
**Typical chain orders:** 2-6 (heavy trig)

## Subdirectories

See `roadmap/industries/defense.md` for the planned application list and
priority order.
...
4. Add a test in `tests/industry/test_defense.py`
