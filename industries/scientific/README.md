...
**Typical chain orders:** 0-4 (varies)

## Subdirectories

See `roadmap/industries/scientific.md` for the planned application list and
priority order.
...
4. Add a test in `tests/industry/test_scientific.py`
