...
**Certification target:** ISO 26262 (ASIL-A through ASIL-D)
**Typical chain orders:** 1-3 (exp + trig)

## Subdirectories

See `roadmap/industries/automotive.md` for the planned application list and
priority order.
...
4. Add a test in `tests/industry/test_automotive.py`
