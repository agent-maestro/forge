// eml_tan.v -- tan(x) in Q<WIDTH-FRAC>.<FRAC> fixed-point.
//
// Status: SCAFFOLD. Implements 3-term Taylor series valid for
// x in [-pi/4, pi/4]. Outside this range the series diverges
// rapidly -- caller is responsible for range reduction or for
// instantiating eml_sin / eml_cos and dividing.
//
//   tan(x) ~= x + x^3/3 + 2*x^5/15 + 17*x^7/315    (|x| <= pi/4)
//
// Pipeline: 4 stages.
